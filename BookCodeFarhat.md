...
In this Tidy Data there are 180 observations (rows) and 561 variables (Columns) that are the values obtained by the sensors for each observation.
###The 180 observations (rows), correspond to  a population of 30 people who develop one of six activities.
...
The rows are ordered in the following way: 
1. Activity 1 for Person 1
.... 
30. Activity 1 for Person 30 
31. Activity 2 for Person 1 
... 
60. Activity 2 for Person 30
 ...  
161. Activity 6 for Person 1
... 
180. Activity 6 for person 30


###There are 561 variables, each one is named as Vx, the observations are numeric values based on the output of each sensor.

###the list of variables are:

 ###Vx			Description of the variable		
(Name of the Tidy 
Data Column)    
1     1                    tBodyAcc-mean()-X
2     2                    tBodyAcc-mean()-Y
